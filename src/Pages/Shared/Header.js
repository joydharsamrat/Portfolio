...
const Header = () => {
    ...
    useEffect(() => {
        if (theme === "light") {
            ...
            document.documentElement.classList.add(localStorage.getItem('portfolioTheme'))
            ...
            <div className="navbar bg-transparent top-0 dark:text-white lg:px-12">
                <div className="navbar-start">
                    ...
                    <label className=" hover:bg-gray-100 p-2 rounded dark:hover:bg-gray-600">
                        ...
                        {
                            theme === 'dark' ? <label title='switch to light' className='cursor-pointer' htmlFor='theme'>
                                ...
                                :
                                <label title='switch to dark' className='cursor-pointer' htmlFor='theme'>
