...
const Header = () => {
    ...
    return (
        <div className={`fixed top-0 z-40 bg-gray-800 w-full max-w-[1350px] ${scroll && 'bg-opacity-30 bg-clip-padding backdrop-blur-sm'}`}>
            <div className="navbar top-0 text-white lg:px-12">
                <div className="navbar-start">
                    <div className="dropdown ">
                        ...
                        <ul tabIndex={0} className="menu bg-gray-600 menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-52">
