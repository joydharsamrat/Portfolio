                    ...
                    <div className='card h-full lg:p-10'>
                        {activeSlide === 0 && (
                            <div className='flex flex-col justify-between h-full'>
                                <div>
                                    <h2 className="text-3xl text-center font-semibold mb-5">Happy Learning</h2>
                                    <p className='text-sm'>Happy Learning is a website for online courses in different programming languages.</p>

                                    <p className='my-5'>
                                        Front-end is developed with React.js and the back end is created with Express.js.
                                        Users can buy a course from the website after login. Also, download Or print option for course
                                        details.
                                        Easy to find questions answered from the faq section.
                                    </p>
                        ...
                        {activeSlide === 1 && (
                            <div className='flex flex-col justify-between h-full'>
                                <div>
                                    <h2 className="text-3xl text-center font-semibold mb-5">MobiHub</h2>
                                    <p className='text-sm'>MobiHub Is a mobile phone resale website.</p>
                                    <p className='my-5'>
                                        Front-end is developed with React.js and the back end is created with Express.js.



                                        It has a Firebase authentication system. And JWT has been used too to make the website safer.


                                        Users can log in as sellers or buyers. Sellers can post their products for sale. And buyers can book products they like and pay for them by card.

                                        there can be 3 types of users on this website, Admin,Seller and buyer
                                        every type of user has different dashboard routes, one can not enter other users route.
                                        User must login to book any product or see his/her booked product or pay for that.
                                        A user can add a product to his/her wishlist to buy letter
                                        If there is any issue with any product user can report it to the admin,
                        ...
                        {activeSlide === 2 && (
                            <div className='flex flex-col justify-between h-full'>
                                <div>
                                    <h2 className="text-3xl text-center font-semibold mb-5">Storyteller</h2>
                                    <p className='text-sm'>Storyteller is a wedding photographer hiring and reviewing website.</p>

                                    <p className='my-5'>
                                        Front-end is developed with React.js and the back end is created with Express.js.
                                        The admin can post his/her packages of photography.Users can see the services admin provide. And users can add, edit and
                                        delete reviews about services they have received.
                                    </p>
                                    <p className='text-xs'>technologies Used : React, Express js, Tailwind CSS, MongoDB, Firebase,.</p>
                                </div>
                                <div className='flex items-center gap-3 mt-5'>
