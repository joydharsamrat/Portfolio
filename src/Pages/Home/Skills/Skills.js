        ...
        <div ref={ref} data-aos="fade-up" className='text-gray-100 mb-10' id='skills'>
            ...
            <div className='my-20 flex justify-center items-center gap-20 flex-wrap'>
                ...
                <div className='flex flex-col items-center justify-center gap-2'>
                    <motion.div initial={{ scale: .1 }} animate={isInView ? { rotateX: 360, scale: 1 } : 'none'} transition={{ delay: .5, duration: 1 }} className='h-24 w-24   rounded-full flex items-center justify-center '>
                ...
                <div className='flex flex-col items-center justify-center gap-2'>
                    ...
                    <motion.div initial={{ scale: .1 }} animate={isInView ? { rotateX: 360, scale: 1 } : 'none'} transition={{ delay: .5, duration: 1 }} className='h-24 w-24   rounded-full flex items-center justify-center '>
                        <img className='rounded-full' src="https://i.ibb.co/V2VLD4Y/react.png" alt="" />
                    </motion.div>
                    <div>
                ...
                <div className='flex flex-col items-center justify-center gap-2'>
                    ...
                    <motion.div initial={{ scale: .1 }} animate={isInView ? { rotateX: 360, scale: 1 } : 'none'} transition={{ delay: .5, duration: 1 }} className='h-24 w-24   rounded-full flex items-center justify-center '>
                        <img className='rounded-full' src="https://i.ibb.co/PgBcrJX/express.webp" alt="" />
                    </motion.div>
            ...
            <div className='flex gap-32 justify-center flex-wrap' style={{ rowGap: '3rem', columnGap: '6rem' }}>
                ...
                <div className='flex items-center gap-5'>
                    <img className='h-8 w-8' src="https://i.ibb.co/ts73rXb/css.png" alt="" />
                    <p className='text-xl font-bold'>CSS3</p>
                </div>
                <div className='flex items-center gap-5'>
                    <img className='h-8 w-8' src="https://i.ibb.co/tpR55Qb/sass-image-depositphotos-bgremover.png" alt="" />
                    <p className='text-xl font-bold'>SASS</p>
                </div>
                <div className='flex items-center gap-5'>
                    <img className='h-8 w-8 rounded-full' src="https://i.ibb.co/559qhbp/nextjs-logo-square.webp" alt="" />
                    <p className='text-xl font-bold'>NEXT.JS</p>
                </div>
                <div className='flex items-center gap-5'>
                    <img className='h-8 w-8 rounded-full' src="https://i.ibb.co/WtT08bz/redux.png" alt="" />
                    <p className='text-xl font-bold'>REDUX</p>
                </div>
                <div className='flex items-center gap-5'>
                    <img className='h-8 w-8 rounded-full' src="https://i.ibb.co/c2v3FDF/Mongo-DB-Emblem.jpg" alt="" />
